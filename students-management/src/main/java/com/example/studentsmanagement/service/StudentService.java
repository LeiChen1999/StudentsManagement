...
public class StudentService {
    ...
    public List<Student> getStudentsContainsInName(String name) {
        return studentMapper.getStudentsContainsInName("%" + name + "%");
    }

    public List<Student> getStudentsInClass(int year, String className) {
        return studentMapper.getStudentInClass(year, className);
    }
}
